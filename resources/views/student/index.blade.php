        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>
                        Student Data
                        <input placeholder="Search name, course" type="text" name="search" id='search_id' style="width: 16%;font-size: 16px;"/> 
                        <!-- <button type="button" class="btn btn-primary search_student">Search</button> -->
                        &nbsp;<a class="btn btn-warning  float-end" href="{{ route('export-csv') }}">Export Data</a>
